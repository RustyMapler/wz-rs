...
impl WzObject {
    ...
    fn parse_object(&mut self) -> Result<(), Error> {
        unsafe {
            ...
            if let Ok(properties) = parse_property(self, self.reader, self.offset) {
        ...
        for _ in 0..num_entries {
            ...
            match property_type {
                ...
                9 => {
                    ...
                    let extended = parse_extended_property(root_obj, reader, offset, name.clone())?;
    ...
    unsafe {
        ...
        match property_type.as_str() {
            ...
            "Canvas" => {
                ...
                if byte == 1 {
                    (*reader).skip(2)?;
                    properties = parse_property(root_obj, reader, offset)?;
                }
